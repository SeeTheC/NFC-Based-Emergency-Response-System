...
class ControlPanelController extends Controller
{
    ...
    {     
        ...
        $info=EmergencyCall::orderBy('id', 'DESC')->get();        
    ...
    public function emergencyCallPost(Request $request)
    {
      ...
      MailController::sendEmergencyMail($latt,$long);
      return $result;
    } 
    // get 
    ...
    public function testMail(){    
      MailController::sendEmergencyMail(19.12345,72.533433);  
